...
chordsAuto = \chordmode {
  % Dotted-half per bar (3/4): one chord per measure
  s2. d2. s2. s2. e:52. s2. s2. s2. e:52. s2. s2. s2. e:52. s2. s2. s2. e:52. s2. s2. s2. s2. s2. s2. s2. s2. s2. s2. s2. s2. s2. s2. s2. s2. s2. s2. s2. s2. s2. s2. s2. s2.
}
...
\score {
  <<
    \new ChordNames \with { \set chordChanges = ##t } { \chordsAuto }
    \new StaffGroup <<
      \new Staff = "violin" \with { instrumentName = "Violin" } { \clef treble \melody }
      \new Staff = "alto" \with { instrumentName = "Alto" } { \clef alto \viola }
